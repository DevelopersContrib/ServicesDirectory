...
<html>
  <head>
    ...
    <style>
        ...
        .inside-content{
            background: url("http://d2qcctj8epnr7y.cloudfront.net/images/jayson/texturePaper.jpg") repeat scroll 0 0 rgba(0, 0, 0, 0);
            padding-top: 15px;
            padding-bottom: 15px;
            margin: 15px 0;
            border-radius: 3px;
...
<h3>Your Coderwall Account and Site.</h3>
<p>
...
<li>the Content is not obscene, libelous or defamatory, hateful or racially or ethnically objectionable, and does not violate the privacy or publicity rights of any third party;</li>
...
<li>your account is not named in a manner that misleads your readers into thinking that you are another person or company. For example, your account’s URL or name is not the name of a person other than yourself or company other than your own; and</li>
<li>you have, in the case of Content that includes computer code, accurately categorized and/or described the type, nature, uses and effects of the materials, whether requested to do so by Coderwall or otherwise.</li>
</ul>
<p></p>
<p>
...
<ol>
<li>Identify in sufficient detail the copyrighted work you believe has been infringed upon. This includes identification of the web page or specific posts, as opposed to entire sites. Posts must be referenced by either the dates in which they appear or by the permalink of the post. Include the URL to the concerned material infringing your copyright (URL of a website or URL to a post, with title, date, name of the emitter), or link to initial post with sufficient data to find it.</li>
<li>Identify the material that you allege is infringing upon the copyrighted work listed in Item #1 above. Include the name of the concerned litigious material (all images or posts if relevant) with its complete reference.</li>
<li>Provide information on which Assembly Made may contact you, including your email address, name, telephone number and physical address.</li>
<li>Provide the address, if available, to allow Assembly Made to notify the owner/administrator of the allegedly infringing webpage or other content, including email address.</li>
...
<p>or email notification to copyright@coderwall.com.</p>
<p>For the fastest response, please send a plain text email. Written notification and emails with PDF file or image attachements may delay processing of your request.</p>
...
<p>The Website is provided “as is”. Assembly Made and its suppliers and licensors hereby disclaim all warranties of any kind, express or implied, including, without limitation, the warranties of merchantability, fitness for a particular purpose and non-infringement. Neither Assembly Made nor its suppliers and licensors, makes any warranty that the Website will be error free or that access thereto will be continuous or uninterrupted. You understand that you download from, or otherwise obtain content or services through, the Website at your own discretion and risk.</p>
